...
async function main() {
  ...
  const prodData: ProductDef[] = [
    ...
    { id: "prod-6", sku: "SW-001", name: "Network Switch 24-Port", type: "finished_good", catIdx: 3, supIdx: 3, whIdx: 1, price: 8500, cost: 6200, stock: 12, min: 5, max: 50, desc: "Gigabit managed network switch", loc: "D-01-01", barcode: "8850001234611", image: "https://picsum.photos/seed/switch/400/400" },
    ...
    { id: "prod-8", sku: "PCB-001", name: "Mainboard PCB Assembly", type: "raw_material", catIdx: 0, supIdx: 4, whIdx: 3, price: 4500, cost: 3200, stock: 200, min: 50, max: 1000, desc: "Custom PCB for laptop assembly", loc: "F-01-01", barcode: "8850001234635", image: "https://picsum.photos/seed/mainboard/400/400" },
    ...
    { id: "prod-10", sku: "ALU-001", name: "Aluminum Frame Kit", type: "raw_material", catIdx: 1, supIdx: 2, whIdx: 4, price: 2800, cost: 1900, stock: 80, min: 20, max: 400, desc: "Extruded aluminum frame for desk assembly", loc: "G-01-01", barcode: "8850001234659", image: "https://picsum.photos/seed/frame/400/400" },
  ]
