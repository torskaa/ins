...
async function main() {
  ...
  type ProductDef = { id: string; sku: string; name: string; type: "finished_good" | "raw_material"; catIdx: number; supIdx: number | null; whIdx: number; price: number; cost: number; stock: number; min: number; max: number; desc: string; loc: string; barcode: string }
  const prodData: ProductDef[] = [
    { id: "prod-1", sku: "LAP-001", name: "Laptop Pro 15\"", type: "finished_good", catIdx: 0, supIdx: 0, whIdx: 0, price: 45900, cost: 38000, stock: 25, min: 5, max: 100, desc: "High-performance laptop for professionals", loc: "A-01-01", barcode: "8850001234567" },
    { id: "prod-2", sku: "MON-002", name: "Monitor 27\" 4K", type: "finished_good", catIdx: 0, supIdx: 0, whIdx: 0, price: 15900, cost: 12000, stock: 50, min: 10, max: 200, desc: "27-inch 4K UHD monitor", loc: "A-02-01", barcode: "8850001234574" },
    { id: "prod-3", sku: "KB-003", name: "Mechanical Keyboard", type: "finished_good", catIdx: 0, supIdx: 0, whIdx: 0, price: 3900, cost: 2500, stock: 100, min: 20, max: 500, desc: "RGB mechanical keyboard with blue switches", loc: "A-03-01", barcode: "8850001234581" },
    { id: "prod-4", sku: "DESK-001", name: "Standing Desk", type: "finished_good", catIdx: 1, supIdx: 1, whIdx: 0, price: 12900, cost: 8500, stock: 15, min: 5, max: 50, desc: "Electric height-adjustable standing desk", loc: "B-01-01", barcode: "8850001234598" },
    { id: "prod-5", sku: "CHAIR-001", name: "Ergonomic Office Chair", type: "finished_good", catIdx: 1, supIdx: 1, whIdx: 0, price: 8900, cost: 5500, stock: 30, min: 10, max: 100, desc: "Adjustable lumbar support office chair", loc: "B-02-01", barcode: "8850001234604" },
    { id: "prod-6", sku: "SW-001", name: "Network Switch 24-Port", type: "finished_good", catIdx: 3, supIdx: 3, whIdx: 1, price: 8500, cost: 6200, stock: 12, min: 5, max: 50, desc: "Gigabit managed network switch", loc: "D-01-01", barcode: "8850001234611" },
    { id: "prod-7", sku: "PRT-001", name: "Laser Printer A4", type: "finished_good", catIdx: 4, supIdx: 4, whIdx: 2, price: 12500, cost: 9000, stock: 8, min: 3, max: 30, desc: "High-speed monochrome laser printer", loc: "E-01-01", barcode: "8850001234628" },
    { id: "prod-8", sku: "PCB-001", name: "Mainboard PCB Assembly", type: "raw_material", catIdx: 0, supIdx: 4, whIdx: 3, price: 4500, cost: 3200, stock: 200, min: 50, max: 1000, desc: "Custom PCB for laptop assembly", loc: "F-01-01", barcode: "8850001234635" },
    { id: "prod-9", sku: "BATT-001", name: "Lithium Battery 5000mAh", type: "raw_material", catIdx: 0, supIdx: 4, whIdx: 3, price: 1200, cost: 800, stock: 300, min: 100, max: 2000, desc: "Rechargeable lithium-ion battery pack", loc: "F-02-01", barcode: "8850001234642" },
    { id: "prod-10", sku: "ALU-001", name: "Aluminum Frame Kit", type: "raw_material", catIdx: 1, supIdx: 2, whIdx: 4, price: 2800, cost: 1900, stock: 80, min: 20, max: 400, desc: "Extruded aluminum frame for desk assembly", loc: "G-01-01", barcode: "8850001234659" },
  ]
  const products = await Promise.all(prodData.map((p) =>
    prisma.product.upsert({
      ...
      create: {
        ...
        uom: "pcs", leadTime: 7, description: p.desc, location: p.loc,
