...
export default function NewBOMPage() {
 ...
 >
 <CardTitle>Materials ({rows.filter((r) => r.materialId).length} selected)</CardTitle>
 ...
 <div className="sticky bottom-0 -mx-8 -mb-6 px-8 py-4 bg-background border-t border-border flex items-center justify-between z-30">
 <p className="text-xs text-muted-foreground">
