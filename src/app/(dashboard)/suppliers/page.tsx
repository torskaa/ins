...
import { Plus, Truck, Package, Globe, Search } from "lucide-react"
...
<Input placeholder="Search suppliers..." className="pl-9 h-9 w-48" value={search} onChange={(e) => setSearch(e.target.value)} />
 ...
 <Button size="sm" className="h-9 gap-1.5" onClick={handleNew}><Plus className="w-4 h-4" /> Add Supplier <ShortcutBadge shortcut="⌘C" /></Button>
 </div>
 </div>
