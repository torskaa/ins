...
export default function NewTaxRatePage() {
  ...
  return (
    <div className="animate-fade-in pb-28">
      ...
      <div className="page-header mb-5"><h1>New Tax Rate</h1><p>Add a tax rate for VAT or withholding</p></div>
              ...
              <CardContent className="p-4 space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <Field id="name" label="Name" required>
                    <Input id="name" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="VAT 7%" />
                  </Field>
