...
>(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn(
 "flex h-full w-full flex-col overflow-hidden rounded-xl bg-modal",
 className,
 )}
 {...props}
 />
...
>(({ className, ...props }, ref) => (
 ...
 <MagnifyingGlassIcon className="me-3 h-5 w-5 text-muted-foreground/80" />
...
>(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn(
 "relative flex cursor-default select-none items-center gap-3 rounded-md px-2 py-1.5 text-sm outline-none data-[disabled=true]:pointer-events-none data-[selected=true]:bg-surface data-[selected=true]:text-foreground data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
 className,
 )}
 {...props}
 />
